...
public class BuildConstants {
	...
	/**
	 * A variable name in build contexts for the current
	 * build directory
	 */
	...
	/**
	 * A variable name in program arguments and build contexts for the current
	 * project directory
	 */
	...
	public static final String CLEAR_PASSWORDS_GOAL = "clear-passwords";
	
	
	public static final String VARIABLE_NAME_USER_HOME = "user.home";
