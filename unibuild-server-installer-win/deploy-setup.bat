...
echo Deploying server %CATALINA_BASE%\bundle\unibuild-web-setup.war to %CATALINA_BASE%\webapps... 
copy "%CATALINA_BASE%\bundle\unibuild-web-setup.war" "%CATALINA_BASE%\webapps\ROOT.war"