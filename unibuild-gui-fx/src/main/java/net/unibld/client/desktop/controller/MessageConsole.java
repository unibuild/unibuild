...
public class MessageConsole
{
	...
	private ConsoleOutputStream errOutputStream;
	private ConsoleOutputStream stdOutputStream;

	public MessageConsole(TextArea textComponent)
	{
	 ...
	 */
	public MessageConsole(TextArea textComponent, boolean isAppend)
	{
	...
	{
		stdOutputStream = new ConsoleOutputStream(textColor, printStream);
		System.setOut( new PrintStream(stdOutputStream, true) );
	}
	...
	{
		errOutputStream = new ConsoleOutputStream(textColor, printStream);
		System.setErr( new PrintStream(errOutputStream, true) );
	}
	...
	class ConsoleOutputStream extends ByteArrayOutputStream
	{
		...
		private void clearBuffer()
		{
			...
			if (isFirstLine && textComponent.getLength() != 0)
			{
			    buffer.insert(0, "\n");
			}
